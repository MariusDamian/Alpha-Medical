...
function Navbar() {
     ...
     return (
          <div
               className={
                    navbar ? "hidden fixed w-full lg:flex items-center justify-center z-10 h-20 border-b border-gray-800 bg-[#00001a]/70 transition-all duration-500 backdrop-blur-md" : "hidden transition-all duration-700 fixed w-full lg:flex items-center justify-center z-10 h-20 border-gray-500 border-b border-gray-500/0 hover:bg-[#00001a]/70 hover:backdrop-blur-md transform backdrop-blur-none"
               }
          >
