...
function Navbar() {
  ...
  return (
    <div className={scrolled ? "fixed w-full lg:flex items-center justify-center z-20 h-20  bg-[#00001a]/80 transition-all duration-500 backdrop-blur-md" : "transition-all duration-700 fixed w-full lg:flex items-center justify-center z-20 h-20  border-gray-500/0 hover:bg-[#00001a]/80 hover:backdrop-blur-md transform backdrop-blur-none"}>
