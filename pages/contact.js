    ...
    <div>
      ...
      <div className='bg-alpha-bg dark:bg-alpha-bg-dark pb-20'>
        <div className='h-full pt-36 lg:flex hidden flex-col max-w-[1440px] mx-auto'>
          <h1 className='mt-10 mb-20 text-4xl dark:text-white max-w-[1148px] mx-auto w-full'>Contact</h1>
          ...
          <div className='flex flex-row justify-center h-[300px] mt-2 space-x-2'>
            <div className='w-[378px] bg-[#E3E3E3] flex flex-col items-start justify-start pt-24 px-4 text-left pl-14 relative hover:text-white hover:bg-alpha-green transform transition-all duration-300'>
